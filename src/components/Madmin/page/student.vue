    ...
    <div>
        ...
        <div class="container">
            <div class="handle-box">
                ...
                >批量删除</el-button>
                <el-input v-model="studentid" placeholder="学生ID" class="handle-input mr10"></el-input>
...
export default {
    ...
    methods: {
        ...
        getData() {
            this.$axios
            .post('http://localhost:8081/api/stu',{
                code:1
            })
            .then(res => {
        ...
        handleSearch() {
            ...
            for (let i = 0; i < length; i++) {
                if(this.studentid==''){
                        ...
                        if(this.tableData1[i].studentid==this.studentid){
                        j++;
                        continue;
                        }else{
        ...
        addmatch(){
                this.$axios
                .post('http://localhost:8081/api/addstu',{
        ...
        handleDelete(index, row) {
            ...
            this.$confirm('确定要删除吗？', '提示', {
                ...
                this.$axios
                .post('http://localhost:8081/api/deletestu',{
        ...
        delAllSelection() {
            ...
            let t=0;
            for (let i = 0; i < length; i++) {
                console.log("Tmatchid"+this.tableData[t].studentid);
                 console.log("Mmatchid"+this.multipleSelection[i].studentid);
                 for(let j=0; j<this.tableData.length; j++){
                    if(this.tableData[t].studentid==this.multipleSelection[i].studentid){
                        this.$axios
                        .post('http://localhost:8081/api/deletestu',{
                            studentid:this.tableData[t].studentid,
                        })
                 ...
                 t=0;
                str += this.multipleSelection[i].studentid + ' ';
            }
        ...
        saveEdit() {
                ...
                .post('http://localhost:8081/api/updatestu',{
                    studentid:this.tableData[this.idx].studentid,
                    studentname:this.tableData[this.idx].studentname,
